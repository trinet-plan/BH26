...
def _missing_record(input_data, state, category, node_id, name):
    ...
    return _finish(input_data, state, Status.NOT_EVALUATED,
...
def _conflicting_record(input_data, state, category, records, node_id, name):
    ...
    return _finish(input_data, state, Status.MANUAL_REVIEW,
...
def _transcript(input_data, services, annotation, state, node_id="NF01"):
    ...
    if relevance == "NOT_RELEVANT":
        ...
        return None, _finish(input_data, state, Status.NOT_APPLICABLE,
    ...
    if relevance != "RELEVANT":
        ...
        return None, _finish(input_data, state, Status.NOT_EVALUATED,
...
def _region_path(input_data, services, annotation, state):
    ...
    if critical is True:
        return _finish(input_data, state, Status.MET,
    ...
    if frequent is True:
        return _finish(input_data, state, Status.NOT_APPLICABLE,
